...
var essayChecker = function essayChecker() {
  ...
  var checkChar = function checkChar(char, text) {
    return text.split('')
  ...
  // ignores punctuation
  var checkTerm = function checkTerm(term, text) {
    return text.replace(/[^\w\s]|_/g, '')
                 .replace(/\s+/g, ' ')
                 .split(' ')
  ...
  var checkText = function checkText(type, element) {
